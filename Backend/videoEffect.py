...
def createCombineImages(image_paths, output_path,
                        ...
                        ImagesOnVideoDefined=False, additionalImagePath=None,
    ...
    final = concatenate_videoclips(clips, method='chain', padding=-transition_duration)
    # final = concatenate_videoclips(clips, method='compose', padding=-transition_duration)
    final.write_videofile(output_path,
                          fps=fps, codec='libx264',
                          preset='ultrafast', threads=16)

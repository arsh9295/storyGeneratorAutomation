...
def generateVideoWithImages(finalPath, imageDurationEachImage):
    ...
    combineImage_start_time = datetime.now()
    ...
    combineImage_end_time = datetime.now()
    if gv.addMusic:
    ...
    combineCompletevideo_start_time = datetime.now()
    ...
    combineCompletevideo_end_time = datetime.now()

    print(f"Total time in combining Image: {combineImage_end_time - combineImage_start_time}")
    print(f"Total time in creating video: {combineCompletevideo_end_time - combineCompletevideo_start_time}")